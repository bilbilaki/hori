...
///
/// The [TransparentBackgroundPainter] widget is a [CustomPainter] that paints a
...
class TransparentBackgroundPainter extends CustomPainter {
  /// Creates a new [TransparentBackgroundPainter] with the given colors.
  ///
  /// The [primary] and [secondary] colors are used to alternate between the
  /// cells in the grid.
  const TransparentBackgroundPainter({
