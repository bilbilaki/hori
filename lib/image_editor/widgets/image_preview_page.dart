...
import 'package:hori/image_editor/widgets/transparent_background_painter.dart';
...
///
/// The [ImagePreviewPage] widget is a stateful widget that shows a preview of
...
class ImagePreviewPage extends StatefulWidget {
  /// Creates a new [ImagePreviewPage] widget.
  ///
...
/// The state for the [ImagePreviewPage] widget.
///
...
class _ImagePreviewPageState extends State<ImagePreviewPage> {
  ...
  Future<void> _downloadImage() async {
    try {
      ...
      String fileName = 'ai_image_editor_'
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Theme(
        ...
        child: Scaffold(
          ...
          body: CustomPaint(
            painter: const TransparentBackgroundPainter(
