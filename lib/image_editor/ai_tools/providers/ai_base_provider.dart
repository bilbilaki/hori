...
abstract class AiBaseProvider {
  ...
  String buildSystemMessage(ProImageEditorState editor) {
    ...
    final history = {
      ...
      'transform':
          state.transformConfigs.isNotEmpty ? state.transformConfigs.toMap() : null,
  ...
  Future<void> handleAiResponse(
    ...
    try {
      ...
      final tuneAdjustments = result.containsKey('tune') && result['tune'] is List
          ? (result['tune'] as List)
